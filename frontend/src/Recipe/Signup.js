...
function Signup() {
  ...
  const clickHandler = async () => {
    ...
    try {
      let result = await fetch(`${API_BASE}/api/auth/register`, {
        method: 'post',
      ...
      setApiError('Unable to sign up. Please try again.');
    }
  };
  ...
  return (
    ...
    <input type="text" className="form-control" /* id="exampleInputEmail1"  */aria-describedby="emailHelp" placeholder='Ritanshu Nijhawan'  value={name}
